...
RT_USED const struct sec_configuration sec_config =
{
    ...
    .ftab[3] = {.base = 0x12208000, .size = 0x00020000,  .xip_base = 0x20020000, .flags = 0},
    .ftab[4] = {.base = 0x12218000, .size = 0x00240000,  .xip_base = 0x12218000, .flags = 0},
    .ftab[5] = {.base = FLASH_BOOT_PATCH_START_ADDR, .size = FLASH_BOOT_PATCH_SIZE, .xip_base = BOOTLOADER_PATCH_CODE_ADDR, .flags = 0},
    .ftab[7] = {.base = 0x12208000, .size = 0x00020000,  .xip_base = 0x20020000, .flags = 0},
    .ftab[8] = {.base = 0x12218000, .size = 0x00240000,  .xip_base = 0x12218000, .flags = 0},
    .ftab[9] = {.base = BOOTLOADER_PATCH_CODE_ADDR,  .size = FLASH_BOOT_PATCH_SIZE, .xip_base = BOOTLOADER_PATCH_CODE_ADDR, .flags = 0},
    .imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_IMG_HCPU)] = {.length = 0x003C1E0C, .blksize = 512, .flags = DFU_FLAG_AUTO},
    .imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_IMG_LCPU)] = {.length = 0xFFFFFFFF},
    .imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_IMG_BL)] = {.length = 0x0000E1F4, .blksize = 512, .flags = DFU_FLAG_AUTO},
    ...
    .imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_IMG_HCPU2)] = {.length = 0x003C1E0C, .blksize = 512, .flags = DFU_FLAG_AUTO},
    .imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_IMG_BOOT2)] = {.length = 0xFFFFFFFF},
    .ftab[DFU_FLASH_HCPU_EXT2] = {.base = 0x12008000, .size = 0x00200000,  .xip_base = 0x12008000, .flags = 0},
    .imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_HCPU_EXT2)] = {.length = 0x0016A7D8, .blksize = 512, .flags = DFU_FLAG_AUTO},
