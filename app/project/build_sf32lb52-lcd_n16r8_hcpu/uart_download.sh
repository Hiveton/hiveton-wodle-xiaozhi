...
sftool -p "$input" -c SF32LB52 -m nor write_flash "bootloader/bootloader.bin@0x12208000" "main.bin/ER_IROM2.bin@0x12AE0000" "main.bin/ER_IROM3.bin@0x12460000" "main.bin/ER_IROM1.bin@0x12218000" "dfu_pan/dfu_pan.bin@0x12008000" "ftab/ftab.bin@0x12000000"
